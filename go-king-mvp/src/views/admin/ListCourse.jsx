...
const ListCourse = () => {
  ...
  return (
    <div className="bg-emerald-100 flex min-h-screen">
      ...
      <div className="container-right ml-10 text-gray-800 flex flex-col my-5">
        <div>
          <div>
            ...
            <tbody>
              {data.map((value) => {
                return (
                  <tr key={(value.id)}>
                    <td
                      className="text-ellipsis overflow-hidden whitespace-nowrap max-w-[144px] px-2"
                    >
                      {value.title}
                    </td>
                    <td className="px-2">{value.type}</td>
                    <td className="px-2">{value.duration}</td>
                    <td className="px-2">{value.facility}</td>
                    <td className="px-2">{value.accent}</td>
                    <td
                      className="text-ellipsis overflow-hidden whitespace-nowrap max-w-[200px] px-2"
                    >
                      {value.description}
                    </td>
                    <td
                    ...
                    <td className="flex flex-row gap-3 px-2">
                      <button
